...
class UpdateConditionForm extends StatefulWidget {
  final String name;
  ...
  @override
  _UpdateConditionFormState createState() => _UpdateConditionFormState();
}

class _UpdateConditionFormState extends State<UpdateConditionForm> {
